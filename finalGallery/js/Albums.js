...
var gallery = {
	albums : [
		...
		},
		{
			...
			photos : [
				...
				{	
					src : "images/puntacana-1-19/DSC_0583.jpg",
					title : "Punta Cana", 
					description : "hotel"
				}, 
				{	
 ...
 console.log(gallery.albums.length);
 ...
 gallery.albums.push({
			...
			photos: [
				...
				}, 
				{
					...
					title : "frosty pond", 
					description : "some du feeling cold"
				} 
			]
		}
               
           );
   gallery.albums[0].photos.push({src:"images/puntacana-1-19/DSC_0590.jpg",
                 title:"punta cana ",
                 description:"Beach ", });

  console.log(gallery.albums[0].photos.length);